...
- Операции с числами с плавающей точкой не всегда точны. Это нормально. Такое поведение характерно для большинства языков программирования и объясняется устройством компьютерной памяти.
