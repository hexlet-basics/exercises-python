...
Официальный стандарт оформления кода _PEP8_ не отдает предпочтения одинарным или двойным кавычкам: важно выбрать один стиль и придерживаться его. В этом курсе мы используем двойные, а одинарные берем тогда, когда внутри строки есть двойные кавычки.
