...
А _good_ превращается в такую последовательность.
...
- Python по умолчанию использует UTF-8, но иногда приходится явно указывать кодировку при чтении файлов, например `open('file.txt', encoding='utf-8')`.
