...
Все отлично. Операция сложения допустима для чисел, поэтому программа отработает и выведет на экран _8_. А что будет, если попробовать сложить число и строку?
