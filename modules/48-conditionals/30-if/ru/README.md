...
Рассмотрим функцию, которая определяет тип переданного предложения. Если оно оканчивается на знак вопроса, функция вернет `"question"`. В противном случае — `"normal"`.
