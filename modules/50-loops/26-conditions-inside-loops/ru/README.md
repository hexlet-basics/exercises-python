...
В теле цикла, как и в теле функции, можно выполнять инструкции. Поэтому внутри цикла можно использовать все изученное ранее, в том числе условные конструкции.
...
# Если вы ничего не нашли, то результат равен 0
...
Это агрегирующая задача. Несмотря на то, что она считает не все символы, чтобы подсчитать сумму, приходится анализировать каждый символ. В отличие от рассмотренных циклов, этот цикл содержит условие внутри тела.
